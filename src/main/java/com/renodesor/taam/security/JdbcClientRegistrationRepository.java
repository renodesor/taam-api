...
public class JdbcClientRegistrationRepository implements ClientRegistrationRepository, Iterable<ClientRegistration> {
    ...
    private static final String COLUMN_NAMES = "registration_id, client_id, client_secret, client_authentication_method,"
            + "authorization_grant_type, client_name, redirect_uri, scopes, authorization_uri, token_uri, jwk_set_uri,"
            + "issuer_uri, user_info_uri, user_info_authentication_method, user_name_attribute_name,configuration_metadata";
    ...
    private static final String INSERT_CLIENT_REGISTERED_SQL = "INSERT INTO " + TABLE_NAME + "(" + COLUMN_NAMES + ")"
            + "VALUES(?,?, ?, ?, ?, ?, ?, ?, ?,?,?,?,?,?,?,?)";

    private static final String UPDATE_CLIENT_REGISTERED_SQL = " UPDATE " + TABLE_NAME + " SET client_id = ?, "
            + " client_secret = ?, client_authentication_method = ?, authorization_grant_type=?, client_name=?, "
            + " redirect_uri=?, scopes=?, authorization_uri=?, token_uri=?, jwk_set_uri= ?, issuer_uri=?,"
            + " user_info_uri=?, user_info_authentication_method=?, user_name_attribute_name=?,"
    ...
    public ClientRegistration findByRegistrationId(String registrationId) {
        ...
        return this.findBy(registrationId);
    }

    private ClientRegistration findBy(Object... args) {
        List<ClientRegistration> result = this.jdbcOperations.query(LOAD_CLIENT_REGISTERED_QUERY_SQL
                + "registration_id=?", this.clientRegistrationRowMapper, args);
    ...
    public static class ClientRegistrationRowMapper implements RowMapper<ClientRegistration> {
        ...
        private static AuthorizationGrantType resolveAuthorizationGrantType(String authorizationGrantType) {
            if (AuthorizationGrantType.AUTHORIZATION_CODE.getValue().equals(authorizationGrantType)) {
                ...
                return AuthorizationGrantType.REFRESH_TOKEN.getValue().equals(authorizationGrantType) ?
                        AuthorizationGrantType.REFRESH_TOKEN : new AuthorizationGrantType(authorizationGrantType);
            }
        }
        ...
        private static ClientAuthenticationMethod resolveClientAuthenticationMethod(String clientAuthenticationMethod) {
            if (ClientAuthenticationMethod.CLIENT_SECRET_BASIC.getValue().equals(clientAuthenticationMethod)) {
                ...
                return ClientAuthenticationMethod.NONE.getValue().equals(clientAuthenticationMethod) ?
                        ClientAuthenticationMethod.NONE : new ClientAuthenticationMethod(clientAuthenticationMethod);
            }
        }
        ...
        private static AuthenticationMethod resolveUserInfoAuthenticationMethod(String userInfoAuthenticationMethod) {
            if (AuthenticationMethod.FORM.getValue().equals(userInfoAuthenticationMethod)) {
                ...
                return AuthenticationMethod.QUERY.getValue().equals(userInfoAuthenticationMethod) ?
                        AuthenticationMethod.QUERY : new AuthenticationMethod(userInfoAuthenticationMethod);
            }
        }
    ...
    public static class ClientRegistrationParametersMapper implements Function<ClientRegistration, List<SqlParameterValue>> {
        ...
        public List<SqlParameterValue> apply(ClientRegistration clientRegistration) {
            return Arrays.asList(new SqlParameterValue(12, clientRegistration.getRegistrationId()),
                    new SqlParameterValue(12, clientRegistration.getClientId()),
                    new SqlParameterValue(12, clientRegistration.getClientSecret()),
                    new SqlParameterValue(12, clientRegistration.getClientAuthenticationMethod().getValue()),
                    new SqlParameterValue(12, clientRegistration.getAuthorizationGrantType().getValue()),
                    new SqlParameterValue(12, clientRegistration.getClientName()),
                    new SqlParameterValue(12, clientRegistration.getRedirectUri()),
                    new SqlParameterValue(12, StringUtils.collectionToCommaDelimitedString(clientRegistration.getScopes())),
                    new SqlParameterValue(12, clientRegistration.getProviderDetails().getAuthorizationUri()),
                    new SqlParameterValue(12, clientRegistration.getProviderDetails().getTokenUri()),
                    new SqlParameterValue(12, clientRegistration.getProviderDetails().getJwkSetUri()),
                    new SqlParameterValue(12, clientRegistration.getProviderDetails().getIssuerUri()),
                    new SqlParameterValue(12, clientRegistration.getProviderDetails().getUserInfoEndpoint().getUri()),
                    new SqlParameterValue(12, clientRegistration.getProviderDetails().getUserInfoEndpoint().getAuthenticationMethod().getValue()),
                    new SqlParameterValue(12, clientRegistration.getProviderDetails().getUserInfoEndpoint().getUserNameAttributeName()),
                    new SqlParameterValue(12, this.writeMap(clientRegistration.getProviderDetails().getConfigurationMetadata())));
        }
